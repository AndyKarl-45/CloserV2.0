...
if($statut==1){
    ...
    echo $date_depart[$j].'</br>';
        ...
        $sql = "UPDATE etat_professionnel_ing SET  entreprise=:entreprise, reference=:reference, fonction=:fonction, date_arrive=:date_arrive, date_depart=:date_depart where id_perso = '$id'  and id_etat_professionnel = '$id_etat[$j]' ";
    ...
    // echo $j.'</br>';        
                ...
                $sql = "INSERT INTO etat_professionnel_ing (id_perso,entreprise, reference, fonction, date_arrive, date_depart)
        ...
        if($sql)
                                    {
                                        ?>
                                        <script>
                                            alert('Ingénieur a été bien mis à jour.');
                                                  window.location.href='<?=$ingenieur['option2_link']?>';
                                        </script>
                                        <?php
                                    }
