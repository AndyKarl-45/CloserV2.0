    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"> <i class=" fa fa-address-card" style="color: silver"></i> Fiche d'Inscription</h1>
                                                                    ...
                                                                    <table class="table  table-hover table-condensed"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width:50%">
                                                                                ...
                                                                                border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="auteur" value="<?=$nom_user_perso?>"
                                                                                           disabled>
                                                                                </div>
