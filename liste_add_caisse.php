        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" style="padding:20px 50px;">
                    <h3 align="center"><i class="fas fa-map"></i> <b>Nouvelle Caisse</b></h3>
                    <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
                </div>
                <div class="modal-body" style="padding:40px 50px;">
                    <form class="form-horizontal" action="save_add_caisse.php" name="form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="caisse" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Nom Caissière:</label>
                            <div class="col-sm-12">
                                <input type="text" name="caissier" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Solde</label>
                            <div class="col-sm-12">
                                <input type="number" name="somme" class="form-control" value="0" disabled>
                            </div>
                        </div>
                            <div class="form-group">
                            <label>Date:</label>
                            <div class="col-sm-12">
                                <input type="date" name="date_caisse" class="form-control">
                            </div>
                        </div>
                            <div class="col-sm-12">
                                <center>
