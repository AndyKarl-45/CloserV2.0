...
<div class="modal fade" id="ajouter_pj_prof_ing<?= $id_personnel; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="save_pj_prof_ing.php" name="form" method="post" enctype="multipart/form-data">
