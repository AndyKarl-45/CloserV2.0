...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4"><i class=" fas fa-user-graduate" style="color: silver"></i> NOM MEMBRE: <?=$nom.' '.$prenom.' ('.$matricule.')'?> </h1>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_ing_pers.php" method="POST">
                                                    <div class="card-header">
                                                ...
                                                ?>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                background: transparent;" required>
                                                                                    <option value="0" selected=""><?=$statut?></option>
