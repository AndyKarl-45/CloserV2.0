...
$query  = "SELECT * from demande_particulier where id_dem_part='".$id."'";
$q = $db->query($query);
while($row = $q->fetch())
{ 
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Modifier Statut de la demande particulier: <?=$ref_dem_part?> </h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-header">
                         <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                       <a class="nav-link active" href="<?=$demande_particulier['option2_link']?>">
                                        Annuler
                                        </a>
                                    </li>                                    
                                </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_statut_demande_part.php" method="POST">
                                                    <div class="card-header">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table  table-hover table-condensed" id="myTable">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <?php
                                                echo '<input name="id_dem_part" type="hidden" value="'.$id_dem_part.'">';
                                                ?>
