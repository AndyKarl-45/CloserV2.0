...
$pdf->Image('img/logos2.jpeg', 85,5,60, 40);
...
$pdf->Text(60,85,'A T T E S T A T I O N');
 ...
 $pdf->Text(45,80,'ATTESTATION PROVISOIRE');  
}
...
$pdf->SetFont('Candara-Bold','',14);
$pdf->Text(115,220,iconv('UTF-8', 'windows-1252', 'Le Président de l\'Ordre'));
if($etat_payer==1){
$pdf->SetLineWidth(.5);
$pdf->Line(115, 221, 164, 221);
$pdf->Image('img/cachetOgnic2.png', 115, 223, 50, 45);
}
