                                                     ...
                                                     <tr>
                                                          <td align="center"><?php echo $nom; ?>  </td>       
                                                            <td align="center">
                                                             ...
                                                             <td align="center"><a class="btn btn-danger"  href="delete_quartier.php?id=<?=$id_quat?>" onclick="Supp(this.href); return(false);"  title="supprimer"  style="background-color: transparent">
