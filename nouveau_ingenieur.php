                                            ...
                                            <form action="save_ingenieur.php" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Prénom</label>
                                                            <input class="form-control" type="text" name="prenom_ing">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="email" name="email_ing">
                                                        </div>
                                                    </div>
                                                   <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>N° Ordre <span class="text-danger">*</span></label>
                                                            <input class="form-control" type="text" name="num_ordre">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Phone </label>
                                                            <input class="form-control" type="text" name="tel_ing">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="m-t-20 text-center">
                                                    ...
                                                    <a href="<?=$ingenieur['option2_link']?>" style=" width:150px;" class="btn btn-danger"><font>Annuler</font></a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
