                            ...
                            <div class="card-header">
                             ...
                             <b> 
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active"  data-toggle="modal" data-target="#ajouter_pj_prof_ing<?=$id_personnel?>" href="#">
                            ...
                            <div class="card-body">
                                <div class="well bs-component">
                                    <form class="form-horizontal">
                                        ...
                                        $query = "SELECT * from pj_etat_professionnel_ing where id_personnel='".$id."' ";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            $nom_pj  =$row['nom_pj'];
...
<!--                                             <div class="modal-body" style="padding:40px 50px;">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    include("ajouter_pj_prof_ing.php");
