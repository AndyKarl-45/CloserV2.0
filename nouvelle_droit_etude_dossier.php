    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouveau Droit D'étude de Dossier</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 offset-lg-2">
                                            <form action="save_droit_etude_dossier.php" method="POST">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <?php }else{ 
                                                               ...
                                                               $iResult = $db->query("SELECT * from personnel WHERE id_personnel= $id_perso");
                                                                while ($data = $iResult->fetch()) {

                                                                    $nom_user = $data["nom"] . ' ' . $data["prenom"];
                                                            
                                                                }
                                                                echo '<input type="text" class="form-control" value="'.$nom_user.'" readonly>';
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                            <div>
                                                                <input type="date" class="form-control" name="date_dos">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="id_ing">
                                                               <option value="0" selected="">....</option>
                                                                ...
                                                                $iResult = $db->query("SELECT * FROM  mytable where statut LIKE 'P%'");
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="number" name="payer" value="10000" >
                                                             <!--<input class="form-control" type="hidden" name="payer" value="10000">-->
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="m-t-20 text-center">
                                                    ...
                                                    <a href="<?=$etude_dossier['option2_link']?>" style=" width:150px;" class="btn btn-danger"><font>Annuler</font></a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
