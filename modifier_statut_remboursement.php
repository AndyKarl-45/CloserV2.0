...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Demande de remboursement: <?php echo 'REF'.$id; ?></h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-header">
                         <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                       <a class="nav-link active" href="<?=$remboursement['option2_link']?>">
                                        Annuler
                                        </a>
                                    </li>                                    
                                </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_statut_remboursement.php" method="POST">
                                                    <div class="card-header">
                                                ...
                                                ?>
                                                 ...
                                                 <?php
                                                echo '<input name="id_rem" type="hidden" value="'.$id.'">';
                                                if($etat==1){
                                                ?>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                background: transparent;" >
                                                                                    ...
                                                                                    <option value="2">Pas valide</option>
                                                ...
                                                <?php }elseif($etat==2){?>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" >
                                                                                    <option value="2" selected="">Pas valide</option>
                                                                                    <option value="0">En Cours</option>
