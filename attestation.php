...
//         if($tailsLen<=65){
//             $pdf->Text($letters+=strlen($objets_f[$j]),180+$plus,iconv('UTF-8', 'windows-1252', strtoupper($objets_f[$j]) ));
//               $tailsLen+=strlen($objets_f[$j]);
//         }
//     }
// $plus+=5;
// $autres=2*$ligne;
...
if($etat_payer==1){
$pdf->SetLineWidth(.5);
$pdf->Image('img/cachetOgnic2.png', 130, 228.5, 40, 35,'','','',true);
