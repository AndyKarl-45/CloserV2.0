...
if($statut==1){
	...
	echo $mention[$j].'</br>';
        ...
        $sql = "UPDATE etat_academique_ing SET  diplome=:diplome, session=:session, ecole=:ecole, mention=:mention where id_perso = '$id'  and id_etat_academique = '$id_etat[$j]' ";
    ...
    // echo $j.'</br>';        
                ...
                $sql = "INSERT INTO etat_academique_ing (id_perso, diplome, session, ecole, mention)
        ...
        if($sql)
                                    {
                                        ?>
                                        <script>
                                            alert('Ingénieur a été bien enregistrée.');
