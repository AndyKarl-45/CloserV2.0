...
{               
 ...
 $query1 = "UPDATE mytable SET nom_ing=:nom, prenom_ing=:prenom, id_card_number=:id_card_number, id_card_validity=:id_card_validity, tel_ing=:tel, email_ing=:email,  lieu_naissance=:lieu_naissance, profession=:profession, situation_matrimoniale=:situation_matrimoniale, nombre_enfants=:nombre_enfants, genre=:genre, id_quartier=:id_quartier, id_ville=:id_ville, id_pays=:id_pays, etat=:etat, annee=:annee where id_ingenieur = '$id' ";
                                    ...
                                    if($sql1)
                                    {
                                        ...
                                        <script>
                                            alert('Postulant a été bien modifié.');
                                                    window.location.href='modifier_post.php?id=<?=$id?>';
                                        </script>
                                        <?php
                                    }
