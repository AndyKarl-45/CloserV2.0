    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-tasks" style="color: silver"></i> Liste  des frais d'Attestations </h1>
                    ...
                    <div class="col-xl-12">
                        ...
                        <b>
                            ...
                            <ul class="nav nav-pills" style="float: right;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="<?=$attestation['option1_link']?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                                if($lvl < 10){
                                $query = "SELECT * from droit_attestation where id_ing = $id_perso AND open_close!='1'  order by date_att, ref_ing_att asc";
                                }else{
                                    $query = "SELECT * from droit_attestation where open_close!='1'  order by date_att, ref_ing_att asc";
                                }
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
